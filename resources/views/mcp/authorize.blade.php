        ...
        <div class="rounded-lg border bg-card text-card-foreground shadow-sm">
            ...
            <div class="flex flex-col space-y-1.5 p-6">
                ...
                <p class="text-sm text-muted-foreground text-center">
                    This application will be able to use Peekchimp's read-only MCP tools
                    for aggregate analytics and Search Console reporting.
                </p>
            </div>
            ...
            <div class="p-6 pt-0 space-y-4">
                ...
                <p class="text-xs text-muted-foreground">
                    Peekchimp will not expose visitor identifiers, personal data, raw
                    OAuth tokens, or write operations. Search Console reports may lag
                    several days and may omit privacy-sensitive queries.
                </p>
            </div>
